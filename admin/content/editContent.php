...
<div class="form-group"><label for="id_priv"><b>Privilegio</b></label><select name="id_priv" id="id_priv" class="form-control" required="required"  ><option value='1 '> Administrador</option><option value="2">Desarrollador</option><option value="3">Usuario</option></select></div><div class="form-group"><label for="id_status_user"><b>Estado</b></label><select name="id_status_user" id="id_status_user" class="form-control" required="required"  ><option value='1 '> Activo</option><option value="2">Baja</option></select></div><div class="form-group">
              ...
              </div><div class="space">&nbsp;</div><div class="form-group">
